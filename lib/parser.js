 ...
 * @returns {string[]} An array of parsed text chunks.
 */
  ...
  while (position !== text.length) {
    ...
    if (current === '"') {
      ...
      while (text[position] !== '"') {
        ...
        // We hit the end of the string, no quotation mark still. Parsing error!
 ...
 * @returns {Object[]} A list of parsed arguemnt descriptions.
 */
